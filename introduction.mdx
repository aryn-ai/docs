...
Aryn DocParse (ADP) formerly known as the Aryn Partitioning Service, is a serverless, GPU-powered API for segmenting and labeling PDF documents, doing OCR, and extracting tables and images. It returns the output in JSON. APS runs the Aryn Partitioner and its state-of-the-art, open source
