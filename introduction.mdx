...
The Aryn Partitioning Service (APS) is a serverless, GPU-powered API for segmenting and labeling PDF documents, doing OCR, and extracting tables and images. It returns the output in JSON. APS runs the Aryn Partitioner and its state-of-the-art, open source
...
Or, watch the Aryn Partitioning Service in action in [this video](https://www.aryn.ai/?name=ArynPartitioningService_Intro).
...
[Sign-up here for free] (https://www.aryn.ai/get-started) to get started with an API Key.
