...
* To load your parsed documents in to a vector database, use DocPrep to create a document ETL pipeline in Python for additional processing and loading. It leverages [Sycamore](https://github.com/aryn-ai/sycamore), a scalable, open source document ETL library.
