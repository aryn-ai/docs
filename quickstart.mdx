---
title: 'Quickstart'
description: 'An introduction to the Aryn Partitioning Service'
---


You can use the Aryn Partitioning Service to segment documents into labeled bounding boxes identifying titles, tables, table rows and columns, images, and regular text. The service can segment PDFs, Microsoft Word (.docx and .doc) documents, and Microsoft PowerPoint (.pptx and .ppt) file formats. 
