...
Now that you have see how DocParse can segment complex documents, extract tables, and more, you can use the ``aryn-sdk`` with your application or [DocPrep](https://console.aryn.cloud/docprep) to generate document ETL code to load the output into vector databases. 
...
* To load your parsed documents in to a vector database, use [DocPrep](docprep/getting_started) to create a document ETL pipeline in Python for additional processing and loading. It leverages [Sycamore](https://github.com/aryn-ai/sycamore), a scalable, open source document ETL library.
