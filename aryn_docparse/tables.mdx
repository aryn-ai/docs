...
In [this example](https://colab.research.google.com/drive/1Qpd-llPC-EPzuTwLfnguMnrQk0eclyqJ?usp=sharing), we'll use the DocPerse to extract the “Supplemental Income” table (shown below) from the 10k financial document  of 3M (given below), and turn it into a pandas dataframe. 

<Frame>
  <img src="../images/3m_supplemental_income.png" />
</Frame>

## Extracting Table Call from DocParse
...
## Make a call to Aryn DocParse (ADP) 
...
| Pension and postretirement net periodic benefits | (73) | (128) | (196) |
| Total | 207 | 144 | (26) |
{/* ```markdown output.md
