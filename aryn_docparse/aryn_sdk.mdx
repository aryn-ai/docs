...
``partition_file`` takes the same options as curl, except as keyword arguments. You can find a list of these options [here](options_deep_dive.mdx).
...
For more information, see the [Aryn SDK documentation](https://sycamore.readthedocs.io/en/stable/aryn_cloud/APIs/aryn-sdk/partition.html).
