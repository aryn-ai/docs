...
description: 'Use the Aryn Partitioning Service to extract an image from a battery manual'
icon: 'image'
---
...
Let's focus on the following code that makes a call to the Aryn Partitioning Service (APS) API to extract the image from the PDF.: 
