...
<Note>You can use a [Sycamore document ETL](https://github.com/aryn-ai/sycamore) job to add Properties to your documents from an existing source, like a database. That's beyond this intro tutorial, though!</Note>
