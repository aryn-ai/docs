...
You can write to a an Aryn DocSet using [Sycamore](https://github.com/aryn-ai/sycamore), an open source document ETL framework. This is helpful if you require custom processing, enrichment, or chunking for your documents. For more information on using Aryn as a target for a Sycamore pipeline, [click here](aryn-platform/data-preparation/sycamore_document_etl).
