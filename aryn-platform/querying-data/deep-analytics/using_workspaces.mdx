...
Go to the Workspaces UI by clicking on it in the left nav, and then select the DocSet you want to query. Or, go to your DocSet in the DocSet list page and click the Open Workspace button.
...
After you submit your query, Aryn will generate and show you the query plan, or steps it will take to execute your query. You can choose to run the plan by clicking the Run plan button, or cancel the query by clicking the Cancel query button. This will allow you to submit a new query.

###Editing query plans

If you need to adjust the query plan, select the Edit plan button. You can instruct Aryn to change the plan in natural language using the query box. Submit your instructions, and you should then see the query plan change. Once you are satisfied with the plan, click the Run plan button.
