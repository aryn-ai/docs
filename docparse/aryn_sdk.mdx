...
``partition_file`` takes the same options as curl, except as keyword arguments. You can find a list of options [here](/docparse/processing_options).
...
The full chunking options are documented [here](./chunking_strategies).
