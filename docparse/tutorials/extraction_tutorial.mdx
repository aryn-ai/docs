...
In this [tutorial](fix-link), we'll use the Aryn SDK to extract properties from a [document](https://aryn-public.s3.us-east-1.amazonaws.com/extraction-tutorial/gri.pdf).
