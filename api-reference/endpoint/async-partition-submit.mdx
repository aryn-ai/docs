...
---
This is the Aryn DocParse API for submitted a document to be partitioned (and optionally chunked) asynchronously. Use
...
optional header `X-Aryn-Webhook`. When the job stops running, Aryn will POST to the provided webhook url with a body
like the one below:
