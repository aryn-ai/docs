...
[the async partition result API](async-partition-result) to poll the asynchronous partitioning task and get its result
when its done.
...
```json
{
  "done": [
    {
      "task_id": "aryn:j-47gpd3604e5tz79z1jro5fc"
    }
  ]
}
```
